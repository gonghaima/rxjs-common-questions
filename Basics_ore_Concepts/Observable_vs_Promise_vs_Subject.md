...
- _Use case:_ Streams of user input, HTTP polling, valueChanges in Angular forms
...
- _Use case:_ One-time HTTP requests, loading config at startup
...
- _Use case:_ Sharing data between components, manual event emitters
